...
contract MoonRocksTestToken is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function MoonRocksTestToken() {
        ...
        name = "MoonRocksTestToken";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "MRTT";                                             // Set the symbol for display purposes (CHANGE THIS)
